...
public class Client {
    ...
    // THIS PATTERN SAYS FAVORS ASSOCIATION OVER INHERITANCE BECAUSE DIFFRENT STRATEGY(MOVE/FLY) is required by diffrent SIBLINGS(Bird,Dog etc) OF SAME PARENT(Animal)
    // ALSO A STRATEGY TYPE CAN BE USED ACROSS MULTIPLE(NOT ALL) SIBLINGS.
